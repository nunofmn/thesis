...
The Figures~\ref{fig:demanded-request-reads}–~\ref{fig:error-ratio-reads} represent the write load test evalution results.
...
In graph from Figure~\ref{fig:demanded-request-reads} we can see that the results similar to the write tests results.
...
This is related to the client bottleneck we detected in the write requests load test.
