...
As depicted in Figure~\ref{} is necessary to verify the following:
...
The nodes then verify the following:

\begin{itemize}
	\item Certificate fingerprint obtained from the blockchain match the fingerprint of the received certificate;
	\item Node identifier associated with the certificate in the blockchain, match the peer identifier of the source or target node in the certificate.
\end{itemize}
