...
In the server side, when handling a new request, we fetch the client certificate from the header, verify if the timestamp signature contained in the header was performed by the same client and check if the timestamp within the last minute.
